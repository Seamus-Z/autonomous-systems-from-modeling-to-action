...
- [2.13 前馈（Feedforward）：模型如何参与行动](#ch2-sec13)
- [2.14 学习（Learning）](#ch2-sec14)
- [2.15 安全（Safety）](#ch2-sec15)
- [2.16 系统中的不同时间尺度（Multiple Time Scales）](#ch2-sec16)
- [2.17 分层控制架构（Hierarchical Control Architecture）](#ch2-sec17)
- [2.18 控制层级不等于控制算法](#ch2-sec18)
- [2.19 从感知—思考—行动到闭环自主系统（Sense–Think–Act to Closed-Loop Autonomy）](#ch2-sec19)
...
$$
 \boxed{ \text{真实世界} \rightarrow \text{观测} \rightarrow \text{估计} \rightarrow \text{预测} \rightarrow \text{规划} \rightarrow \text{控制} \rightarrow \text{执行} \rightarrow \text{真实世界} } 
$$
...
$$
 \boxed{ \text{Safety} \text{ is a cross-cutting constraint} } 
$$
...
## 2.17 分层控制架构（Hierarchical Control Architecture）
...
## 2.19 从感知—思考—行动到闭环自主系统（Sense–Think–Act to Closed-Loop Autonomy）
...
$$
 \boxed{ \text{World} \rightarrow \text{Observation} \rightarrow \text{Estimation} \rightarrow \text{Prediction} \rightarrow \text{Planning} \rightarrow \text{Control} \rightarrow \text{Execution} \rightarrow \text{World} } 
$$

同时：

$$
 \boxed{ \text{Learning} \rightarrow \{ \text{Modeling}, \text{Estimation}, \text{Planning}, \text{Control} \} } 
$$
